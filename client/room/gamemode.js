...
// Настройки:
const waiting_players_TIME = 10;
const build_base_TIME = 60;
const game_mode_TIME = 300;
const def_POINTS = game_mode_TIME * 0.2;
const end_Of_match_TIME = 10;
const def_points_MAXCount = 30;
const def_timer_TICKInderval = 1;
const save_POINTSCount = 10;
const RepairPoints_BYSecond = 0.5;
const capture_POINTS = 10;		// Сколько очков, нужно- для захвата.
const MAX_CapturePoints = 15;	// Сколько макс, очков.
const red_capture_w = 1;		// Вес красных, при захвате - спавна.
const blue_capture_w = 2;		// Вес синих, при захвате - спавна.
const capture_restore_w = 1;	// Сколько очков отнимается, если нет красных - в зоне для захвата.
const un_captered_color = new basic.Color(1, 1, 1, 0);
const fake_captured_color = new basic.Color(0, 0, 1, 0); // К какому цвету, стремится зона - при её захвате.
const captured_color = new basic.Color(1, 0, 0, 0);
const max_spawns_by_area = 25;	// Макс спавнов, на - зону.

// Константы:
const waiting_state_value = 'waiting';
const build_mode_state_value = 'build_mode';
const game_state_value = 'game';
const end_0f_match_state_value = 'end_Of_match';
const def_area_tag = 'def';
const capture_area_tag = 'capture';
const hold_position_hint = 'GameModeHint/HoldPosition';
const run_to_blie_point_hint = 'GameModeHint/RunToBliePoint';
const def_blue_area_hint = "GameModeHint/DefBlueArea";

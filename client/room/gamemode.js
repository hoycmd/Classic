...
Да. Ctrl+Shift+I или настройки/инструменты разработчика/консоль. Входишь, там находишь вкладку console, потом вписываешь например:
...
написаны под всем этим текстом). И кстати, так общаться неудобно. Если бы ты просто держал телефон и ноутбук одновременно включенными, я мог бы на телефоне тебе
говорить, а на ноутбуке ты бы пробовал. Но как знаешь...

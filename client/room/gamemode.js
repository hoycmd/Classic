...
привет уже на ноуте я могу откр консоль и писать там? или настройки/инструменты разработчика/консоль.

Да. Ctrl+Shift+I или в настройках инструменты разработчика - консоль выбираешь.
